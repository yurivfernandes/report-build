...
from gpt_reports._gpt_api_keys import GPT_API_KEY
from gpt_reports.settings import FINAL_PLAYBOOK, INITIAL_PLAYBOOK

# SUBSTITUA O GPT_API_KEY pela string com a chave do seu chat gpt
...
class GPTReport(APIView):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.user_story = kwargs.get("user_story")
    ...
    def _get_gpt_data(self) -> str:
        ...
        final_response = requests.post(url=LINK, headers=HEADERS, data=body)
    ...
    def _code_analysis_response(self) -> list:
        ...
        for playbook in playbooks:
            ...
            response = (
                requests.post(
                    url=LINK, headers=HEADERS, data=body))
